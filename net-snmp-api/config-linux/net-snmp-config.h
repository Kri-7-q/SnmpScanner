...
#define NETSNMP_CONFIGURE_OPTIONS " '--disable-agent' '--disable-manuals' '--disable-scripts' '--disable-applicatons' '--disable-cc-perl-checks' '--disable-embedded-perl' '--prefix=/home/christian/net-snmp-ubuntu'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/home/christian/net-snmp-ubuntu/share/snmp/mibs"
...
#define SNMPLIBPATH "/home/christian/net-snmp-ubuntu/lib/snmp"
#define SNMPSHAREPATH "/home/christian/net-snmp-ubuntu/share/snmp"
#define SNMPCONFPATH "/home/christian/net-snmp-ubuntu/etc/snmp"
#define SNMPDLMODPATH "/home/christian/net-snmp-ubuntu/lib/snmp/dlmod"
